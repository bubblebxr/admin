const local: App.I18n.Schema = {
  ...
  page: {
    ...
    manage: {
      ...
      role: {
        title: 'Role List',
        equipmentName: 'Role Name',
        equipmentStatus: 'Role Code',
        equipmentType: 'Role Status',
        IP: 'Role Description',
        menuAuth: 'Menu Auth',
        buttonAuth: 'Button Auth',
        form: {
          equipmentName: 'Please enter role name',
          equipmentStatus: 'Please enter role code',
          equipmentType: 'Please select role status',
          IP: 'Please enter role description'
        },
        addRole: 'Add Role',
        editRole: 'Edit Role'
      },
